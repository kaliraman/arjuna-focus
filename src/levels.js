...
export const LEVELS = [
  { name: "Calibration",      motion: 0.20, distraction: 0.00, ripple: 0.3, clarityFlash: false, eyeHits: 1, calibration: true },
  { name: "The Still Pool",   motion: 0.35, distraction: 0.00, ripple: 0.5, clarityFlash: false, eyeHits: 1 },
  { name: "First Current",    motion: 0.55, distraction: 0.12, ripple: 0.8, clarityFlash: false, eyeHits: 1 },
  { name: "Drifting Leaves",  motion: 0.80, distraction: 0.28, ripple: 1.0, clarityFlash: false, eyeHits: 2 },
  { name: "Restless Water",   motion: 1.10, distraction: 0.42, ripple: 1.3, clarityFlash: false, eyeHits: 2 },
  { name: "The Crowded Sky",  motion: 1.45, distraction: 0.60, ripple: 1.5, clarityFlash: false, eyeHits: 2 },
  { name: "Veil of Glare",    motion: 1.80, distraction: 0.75, ripple: 1.7, clarityFlash: true,  eyeHits: 3 },
  { name: "The Whirling Eye", motion: 2.30, distraction: 0.88, ripple: 1.9, clarityFlash: true,  eyeHits: 3 },
  { name: "Arjuna's Gaze",    motion: 2.90, distraction: 1.00, ripple: 2.1, clarityFlash: true,  eyeHits: 3 },
];
